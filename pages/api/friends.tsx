...
export default function FriendsPage() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "40px auto", padding: 32, background: "#23242a", borderRadius: 24, boxShadow: "0 6px 32px #0008", color: "#fff", fontFamily: "Roboto, Verdana, Arial, sans-serif" }}>
