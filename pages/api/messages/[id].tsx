        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2, marginBottom: isMobile ? 10 : 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span style={nameStyle}>
              {friend?.name || friend?.login || <span style={{color:'#888'}}>Загрузка...</span>}
              {/* Иконка роли */}
                  ...
                  {group.items.map((msg) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {msg.videoUrl ? (
                          <div style={{
                            display: 'flex', flexDirection: 'column', alignItems: isOwn ? 'flex-end' : 'flex-start', gap: 2, margin: '2px 0',
                          }}>
                            <video
                              src={msg.videoUrl.startsWith('/') ? msg.videoUrl : '/' + msg.videoUrl}
                              controls
                              playsInline
                              style={{ width: 120, height: 120, borderRadius: '50%', background: '#111', objectFit: 'cover', border: '2.5px solid #229ed9', boxShadow: '0 2px 12px #229ed955', marginBottom: 2 }}
                            />
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ color: '#fff', fontWeight: 600, fontSize: 18, textAlign: 'center', marginTop: 18, marginBottom: 10 }}>
                  {videoRecording ? `Запись... ${videoTime}s` : 'Готово'}
                </div>
